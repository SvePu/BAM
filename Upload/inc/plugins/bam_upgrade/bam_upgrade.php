...
function bam_upgrade()
{
    ...
    $db->query("ALTER TABLE " . TABLE_PREFIX . "bam ADD `global` INT UNSIGNED DEFAULT 0 AFTER `pinned`;");

    $db->query("ALTER TABLE " . TABLE_PREFIX . "bam ADD `random` INT UNSIGNED DEFAULT 0 AFTER `global`;");

    $db->query("ALTER TABLE " . TABLE_PREFIX . "bam ADD `additional_display_pages` VARCHAR(512) DEFAULT NULL AFTER `random`;");

    $db->query("ALTER TABLE " . TABLE_PREFIX . "bam ADD `forums` VARCHAR(256) DEFAULT NULL AFTER `additional_display_pages`;");
